...
SYSTEM_PROMPT = "Sen İstanbul'da profesyonel bir tur rehberisin. Kısa ve net yanıt ver."
...
def api_voice():
    ...
    if not user_text:
        return jsonify(error="Anlayamadım"), 400
